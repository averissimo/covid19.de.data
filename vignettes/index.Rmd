...
```{r, include=FALSE}
tryCatch({
  .Last.value <- rki.de.district.data::de.nuts.mapping
}, error = function(err) {
  de.nuts.mapping <- landkreis.mapping.raw()
  usethis::use_data(de.nuts.mapping, overwrite = TRUE)
  write_csv2(de.nuts.mapping, path = '../data/de.nuts.mapping.csv')
})
```
...
```{r, include=FALSE}
tryCatch({
  .Last.value <- rki.de.district.data::rki.covid19
