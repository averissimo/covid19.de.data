...
rki.covid19.tmp2 <- update_dataset.no.age()
```

```{r, include=FALSE}
data('rki.covid19.no.age')
if (!exists('rki.covid19.no.age') || (!all(rki.covid19.tmp$object.id %in% rki.covid19.no.age$object.id))) {
  rki.covid19.no.age <- rki.covid19.tmp
